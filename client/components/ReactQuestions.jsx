...
import { setError, sendAnswersToApi, setCurrentQuestionIndex, setAnswers, setCurrentInput, setMovieRec } from '../utils/filmfindrSlice';
import './style.css'
...
const inputs = [
  ...
  const ReactQuestions = () => {
    ...
    const currentQuestionIndex = useSelector(state => state.myReducers.currentQuestionIndex);
        ...
        <div className='questions-container'>
          ...
          <form onSubmit={handleNext} name='questions'>
            ...
            {currentQuestion.type === 'text' ? (
              <input type="text" placeholder={currentQuestion.placeholder} value={currentInput} onChange={(e) => dispatch(setCurrentInput(e.target.value))} />
            ) : (
